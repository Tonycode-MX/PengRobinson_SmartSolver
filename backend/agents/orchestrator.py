...
orchestrator_prompt = ChatPromptTemplate.from_messages([
    ...
    3. Extract ALL exact state variables. You MUST preserve their original units exactly as written by the user. Explicitly separate the numeric value from the unit string in your briefing (e.g., Value: 450, Unit: "R" or Value: 14.7, Unit: "psi").
    ...
    Format the extracted data clearly and pass it as a detailed briefing to the appropriate tool. Do NOT attempt to solve the thermodynamic equations or convert any units to SI yourself. Leave all conversions to the internal system."""),
